...
export const BattleMap = (() => {
    ...
    function create(canvas, optionen = {}) {
        ...
        // Aufraeumen beim Unmount (React-Wrapper MapPanel.jsx): sonst haeuft
        // jedes Oeffnen/Schliessen des Kartenpanels einen weiteren
        // resize-Listener auf einer laengst verworfenen Leinwand an.
        function zerstoeren() { window.removeEventListener('resize', zeichnen); }
        ...
        return {
            ...
            getState, applyState, einpassen, sichtbaresZentrum, setBesitzer, zeichnen, zerstoeren,
